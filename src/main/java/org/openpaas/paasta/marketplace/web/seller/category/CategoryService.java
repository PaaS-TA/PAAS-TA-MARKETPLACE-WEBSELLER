...
import org.openpaas.paasta.marketplace.web.seller.code.CustomCodeList;
...
public class CategoryService {
    ...
    public List<Category> getCategoryListByDeleteYn() {
    	CategoryList categoryList = marketApiRest.send(SellerConstants.TARGET_API_MARKET, SellerConstants.URI_WEB_CATEGORY, HttpMethod.GET, null, CategoryList.class);
