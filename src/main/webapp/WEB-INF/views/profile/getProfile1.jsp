...
<table>
    <tr>
        <td>판매자명</td>
        <td>
            <span class="sellerName">${profile.sellerName}</span>
        </td>
    </tr>
    <tr>
        <td>유형</td>
        <td>
            <span class="businessType">${profile.businessType}</span>
        </td>
    </tr>
    <tr>
        <td>담당자명</td>
        <td>
            <span class="managerName">${profile.managerName}</span>
        </td>
    </tr>
    <tr>
        <td>메일 주소</td>
    ...
    <tr>
        <td>홈페이지 주소</td>
        <td>
            <span class="homepageUrl">${profile.homepageUrl}</span>
        </td>
    </tr>
    <tr>
        <td>등록일</td>
        <td>
            <span class="createdDate">${profile.strCreateDate}</span>
        </td>
    </tr>
</table>
<div>
